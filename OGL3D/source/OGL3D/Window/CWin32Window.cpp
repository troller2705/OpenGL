...
OWindow::OWindow()
{
	...
	m_handle = CreateWindowEx(NULL, MAKEINTATOM(classId), L"Test | OpenGL 3D Game", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
		NULL, NULL, NULL, NULL);
